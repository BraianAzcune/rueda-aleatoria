...
export function ConfigItemRow({
	...
	return (
		<li class="flex items-center gap-2">
			<div class="flex min-w-0 flex-1 items-center gap-2 rounded-xl border border-gray-700 bg-gray-900/60 p-3">
			...
			<button
				type="button"
				class="shrink-0 rounded-xl border border-red-500/40 px-2 py-2 text-red-300 transition hover:bg-red-500/10 hover:text-red-200"
